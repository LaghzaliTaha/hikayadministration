var MyModule = angular.module('MyModule', ['ui.router','Routes','controllers']);
MyModule.controller("addStoryController",function ($scope, $http) {
     ...
     $('#uploadForm').submit(function() {
        ...
        $(this).ajaxSubmit({
            ...
            success: function(response) {
					...
					alert("Vous avez bien insérer article_summary");
...
MyModule.controller("addPartController",function ($scope,$http,$stateParams) {
...
$scope.article.id = $stateParams.id;
  $http.post('/addPart',$scope.article)
...
MyModule.controller("modifyPartController",function ($scope, $http,$stateParams,$state) {
...
$scope.article = {};
$scope.article.id_art = $stateParams.id_art;
$scope.article.id_part = $stateParams.id_part;
$scope.article.content = $stateParams.part_content;

$scope.modifier = function(){
    $http.post('/modifyPart',$scope.article)
            .success(function(data){
              $state.go('home');
                  })
            .error(function(data){
...
MyModule.controller("modifyArtController",function ($scope,$http,$stateParams) {
...
$scope.article = {};
$scope.article.id_art = $stateParams.id_art;
$http.post('/modifyArt',$scope.article)
                .success(function(data) {
                $scope.article = {};
                $scope.article = data;
                            })
...
MyModule.controller("questionController",function ($scope, $http) {
...
MyModule.controller("StoryController",function ($scope, $http) {
  $scope.article = {};
  $http.get('/storiesShow')
          .success(function(data) {
              $scope.article = data;
          })
       .error(function(data) {
